export const heroContent = {
  eyebrow: "임산부 결혼지원금",
  headline: ["첫 임신, 첫 결혼.", "저희가 ", "함께", " 합니다."] as const,
...
export const empathyContent = {
  eyebrow: "낯선 결정의 연속",
  title: ["작은 결정 하나도", "부담스럽게 다가오죠."] as const,
  meta: "최근 6개월 사이 가장 자주 들었던 이야기들이에요.",
  cards: [
    {
      title: "오늘은 괜찮은데, 그날은 모르죠",
      body: "일정은 미리 잡아둬야 하는데, 그날 컨디션이 어떨지는 누구도 예측할 수 없어요. 못 갈까 봐, 한 번 정해두면 못 바꿀까 봐. 마음 한쪽이 늘 가볍지 않습니다.",
    },
    {
      title: "출산 전에 다 끝낼 수 있을까",
      body: "만삭이 가까워질수록 움직임은 줄어드는데, 결혼식도 신혼여행도 그 전에 마무리하고 싶어요. 보이지 않는 타임라인이 매주 시야 안으로 들어옵니다.",
    },
    {
      title: "물어볼 사람이 마땅치 않아요",
      body: "예비 부부이자 예비 부모. 매주 결정이 쌓이는데, 임산부 결혼이라는 상황을 함께 본 사람은 주변에 흔치 않아요. 결국 매번 검색창부터 켜게 됩니다.",
    },
  ],
} as const;
